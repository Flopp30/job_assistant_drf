...
class ProfessionalRole(CustomBaseModel):
    ...
    name = models.CharField(primary_key=True, unique=True, verbose_name='Name', max_length=50)  # Название должности
...
class Skill(CustomBaseModel):
    ...
    name = models.CharField(primary_key=True, unique=True, verbose_name='Name', max_length=25)  # Название навыка
